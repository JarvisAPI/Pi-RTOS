...
minimization problem, and we denote the value of the optimal (minimum-value) solution as OPT(I) for instance, then a PTAS A for the problem is such that A(I) <= (1+ɛ)OPT(I) for every given I and ɛ. 
