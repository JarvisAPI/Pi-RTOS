...
hardness of the task partitioning part (the "spatial" dimension), since the BIN PACKING problem is NP-Complete in the strong sense. Since exact solutions to the partitioning problem are computationally intractable (unless P = NP), our best
